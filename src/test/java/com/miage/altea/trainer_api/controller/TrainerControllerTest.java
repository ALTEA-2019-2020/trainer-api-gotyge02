...
public class TrainerControllerTest {
    ...
    void trainerController_shouldBeAnnotated(){
        var controllerAnnotation =TrainerController.class.getAnnotation(RestController.class);
        assertNotNull(controllerAnnotation);
        var requestMappingAnnotation =TrainerController.class.getAnnotation(RequestMapping.class);
    ...
    void getAllTrainers_shouldBeAnnotated() throws NoSuchMethodException {
        var getAllTrainers =TrainerController.class.getDeclaredMethod("getAllTrainers");
    ...
    void getTrainer_shouldBeAnnotated() throws NoSuchMethodException {
        var getTrainer=TrainerController.class.getDeclaredMethod("getTrainer", String.class);
    ...
    void updateTrainer_shouldBeAnnotated() throws NoSuchMethodException {
        var updateTrainer_shouldBeAnnotated =TrainerController.class.getDeclaredMethod("updateTrainer", String.class, Trainer.class);
